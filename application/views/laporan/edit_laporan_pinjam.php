<div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1>Edit Laporan Pinjam Buku</h1>
            <ol class="breadcrumb">
                <li><a href="<?=base_url();?>welcome"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                <li class="active"><i class="fa fa-table"></i> Edit Laporan Pinjam Buku</li>
            </ol>
          </div>
          </div><!-- /.row -->
 <div class="card-body">
    <form method="post" action="<?=base_url('pinjam/proses_edit_laporan/'.$id_laporan);?>">
      <div class="form-row">
                ...
                <div class="form-group row">
                    ...
                    <?php
                        foreach($d_laporan->result() as $fd_laporan){
                           $id_pinjam = $fd_laporan->id_pinjam;
                           $id_anggota= $fd_laporan->id_anggota;
                           $nama= $fd_laporan->nama;
                           $judul_buku= $fd_laporan->judul_buku;
                           $tanggal_pinjam = $fd_laporan->tanggal_pinjam;
                           $tanggal_kembali = $fd_laporan->tanggal_kembali;
                        }
                    ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                    <select name="id_anggota" class="custom-select form-control" value="<?=$id_anggota;?>">
                        <?php
