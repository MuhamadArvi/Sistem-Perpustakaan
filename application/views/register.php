...
<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
            ...
            <div class="login-logo">
                <a href="<?=base_url('');?>home" style="color: white;">Sistem Informasi <br/><b>Perpustakaan</b></a>
            </div>
            ...
            <div class="login-box-body" style="border:2px solid #226bbf;">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="nisn" name="nisn" required="required" autocomplete="off">
                ...
                <div class="form-group has-feedback">
                <select class="form-control" name="kelas" placeholder="Choose Your Class">
            ...
            <footer>
                ...
                <a style="color: white;"> Copyright &copy; Ruang Baca Sekolah - <?php echo date("Y");?>
                </div>
            </footer>
            </div>
            <!-- /.login-box -->
